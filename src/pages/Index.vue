...
export default {
  ...
  data() {
    return {
      description: 'The ultimate web interface to control your IoT devices'
    }
  },
  metaInfo() {
    return {
      ...
      meta: [
        { key: 'description', name: 'description', content: 'A web interface library to easily manage, control, communicate with your IoT devices.' }
      ]
    }
  }
}
